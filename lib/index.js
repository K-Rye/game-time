...
const game = new Game(ctx, canvas, gameStartButton, playerScore1, playerScore2);
...
gameStartButton.addEventListener('click', toggleGame);
...
function toggleGame() {
  game.toggleGame(gameStartButton); 
} 
